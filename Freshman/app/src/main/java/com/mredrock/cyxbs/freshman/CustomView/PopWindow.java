...
/**
 * Created by FengHaHa on2018/5/26 0026 11:22
 */
public class PopWindow {
    ...
    private PopupWindow build() {
        ...
        if (mHeight == 0) mHeight = ViewGroup.LayoutParams.WRAP_CONTENT;
    ...
    public static class PopupWindowBuilder {
        private PopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context) {
            mCustomPopWindow = new PopWindow(context);
        }
